...
from src.lib.cards import CARD_DOG, CARD_MAH, CARD_DRA, CARD_PHO
from src.lib.combinations import FIGURE_DOG, FIGURE_DRA, SINGLE, STREET, BOMB, PAIR, TRIPLE, FULLHOUSE, STAIR, FIGURE_PHO
...
def calc_statistic_v2(player: int, hand:  list[tuple], combis: list[tuple], number_of_cards:  list[int], _trick_figure: tuple, unplayed_cards: list[tuple]) -> dict:
    assert hand  # wir haben bereits bzw. noch Karten auf der Hand
    assert len(hand) == number_of_cards[player]
