...
class TestPublicState(unittest.TestCase):
    ...
    def test_play(self):
        ...
        self.assertEqual(0, self.pub._trick_player)
        ...
        self.assertEqual(1, self.pub._trick_player)
        self.assertEqual(combi1[1], self.pub._trick_figure)
    ...
    def test_step(self):
        ...
        self.pub._current_player = 0
        self.pub.step()
        self.assertEqual(2, self.pub._current_player)
        self.pub._trick_player = 3
        self.pub._current_player = 3
        self.pub.step()
        self.assertEqual(1, self.pub._current_player)
        ...
        self.pub._current_player = 3
        self.pub.step()
        self.assertEqual(0, self.pub._current_player)
