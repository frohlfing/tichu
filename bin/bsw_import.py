...
"""
Dieses Skript importiert die vom Spiele-Portal "Brettspielwelt" heruntergeladenen Logdateien in eine SQLite-Datenbank.
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="BSW Importer")
