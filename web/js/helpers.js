...
const Helpers = (() => {
    ...
    const _cardDeck = [ // value, suit, label
        [0, 0, 'Hu'], [1, 0, 'Ma'],
        [2, 1, 'S2'], [2, 2, 'B2'], [2, 3, 'G2'], [2, 4, 'R2'],
        [3, 1, 'S3'], [3, 2, 'B3'], [3, 3, 'G3'], [3, 4, 'R3'],
        [4, 1, 'S4'], [4, 2, 'B4'], [4, 3, 'G4'], [4, 4, 'R4'],
        [5, 1, 'S5'], [5, 2, 'B5'], [5, 3, 'G5'], [5, 4, 'R5'],
        [6, 1, 'S6'], [6, 2, 'B6'], [6, 3, 'G6'], [6, 4, 'R6'],
        [7, 1, 'S7'], [7, 2, 'B7'], [7, 3, 'G7'], [7, 4, 'R7'],
        [8, 1, 'S8'], [8, 2, 'B8'], [8, 3, 'G8'], [8, 4, 'R8'],
        [9, 1, 'S9'], [9, 2, 'B9'], [9, 3, 'G9'], [9, 4, 'R9'],
        [10, 1, 'SZ'], [10, 2, 'BZ'], [10, 3, 'GZ'], [10, 4, 'RZ'],
