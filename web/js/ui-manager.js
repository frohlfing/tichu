const UiManager = (() => {
    ...
    function showLobby() {
        if (currentTableView) currentTableView.hide();
        if (currentLobbyView) currentLobbyView.show();
    }

    function showTable() {
        if (currentLobbyView) currentLobbyView.hide();
        if (currentTableView) currentTableView.show();
    }
